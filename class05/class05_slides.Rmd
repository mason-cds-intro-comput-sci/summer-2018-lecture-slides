...
knitr::opts_chunk$set(echo = FALSE, eval = TRUE, fig.width = 5, warning = FALSE,
...
.valign-slide[
```{r luke-skywalker-data, height = "100%"}
...
.pull-right[
```{r starwars-helpdata, out.width = "100%"}
